...
// function 
function addno(){
    let result = nom1+nom2;
    console.log(result);
}
addno();

// function expression (normal function expression)

const subNo=function sub(){
    let result6=nom1-nom2;
    console.log(result6);
}
...
/* In java script , hosting is the default behavior of moving all the declaration at the top of the scope before code  executed*/

// Function declaration 

addNoDeclaration()

/**  when using function declaration you can call the function any ware before function and after function */
function addNoDeclaration(){
    console.log("form of Declaration ");
...
let addNoExpression= function(){
    console.log("from of Expression");
}
/**  when you using expression you must use the calling function after the expression  [before the function is show ERROR ] */
...
// --------------------------------------------------------------------------
   ...
   /**  [IIFE]=> IMMEDIATELY INVOKING FUNCTION EXPRESSION  */
     ...
     (()=>{
        let num1=10;
        let num2=10;
        let result7=num1+num2;
        console.log("IIFE Function :",result7);
...
// --------------------------------------------------------------------------
  ...
  function sumExpense(tiffen,lunch,petrol /** PARAMETERS */){
    let resultS=tiffen+lunch+petrol;
    console.log(`your Expense is $${resultS}`);
  }

sumExpense(520,52,100 /** ARGUMENTS */);
...
let Result= sumExpenseS(40,50,85,58,25)
...
// --------------------------------------------------------------------------
  ...
  let loanResult=Sumexpense(100,50,542,44855,448,22,4);
  console.log(`Total : ${loanResult}`);
...
function calculateTax(cost,title,tax=18){
    ...
    console.log(`Total cost ${title} is : $ ${cost} \n\n GST of Tax (${tax}%) is : $${taxAmount} \n\n Total Amount is : $ ${cost+taxAmount}`);

}

 calculateTax(45,"Food",45);
   ...
   let student ={
    ...
    get function(){
        return `${student.firstNam} ${student.lastNam}`
    },

    set function (value){
        let Values=value.splice("");
        this.firstNam=Values[0];
        this.lastNam =Values[1]?? "";

    },

   };

//    student.firstNam="nayanthara";

   console.log(student.firstNam);
...
let students={
    ...
    get FullName(){
        return`${students.firstN} ${student.lastNam}`;
    },
    set FullName(value){
    ...
    if (value.length<=3)new Error("Name Invalid")
    let values=value.split("");
    this.firstN=values[0];
    this.lastN=values[1]??"";
